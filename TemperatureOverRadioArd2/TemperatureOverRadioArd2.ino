...
{ 
  ...
  if (numberOfDevices=0) return -100;
...
//-------------------------PID CALCULATION and switching relay------------------------------
  ...
  if (TimeDif<PIDStepDuration){
    ...
    else {Ratio=0.5;} //if no temperature sensor half of the time on, half of the time off
    
    //Ratio if end of step matches exactly when last temperatrue was measured
